// src/features/syslog/pages/AdminSystemLogPage.jsx
...
import api from '@/common/api/client.js';        // ✅ 프로젝트 공용 axios 인스턴스
import '@/features/system/styles/admin-system.css';

// ★ 공용 알림 모듈(SweetAlert2 래퍼) 사용
import { alertInfo, alertError } from '@/common/ui/alert.js';
