// src/features/course/pages/ClassOpsPage.jsx
// ============================================================================
...
// 알럿
import { alertSuccess, alertError, alertInfo, confirmDialog } from '@/common/ui/alert.js';
...
export default function ClassOpsPage() {
    ...
    const onRestore = async () => {
        ...
        try {
            ...
            // academyCourseApi.js: 프런트 targets {class,subject,timeslot} → 서버 {clazz,subject,timeslot} 변환 처리
