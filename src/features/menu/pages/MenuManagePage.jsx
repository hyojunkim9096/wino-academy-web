// src/features/menu/pages/MenuManagePage.jsx
// ============================================================================
// 메뉴 관리 컨테이너
...
import { getMenuTree, createMenu, updateMenu, deleteMenu, reorderMenu } from '@/features/menu/api/menuApi.js';
import { getCodes as getCommonCodes } from '@/features/system/api/commonCodeAdminApi.js';
import { alertError, alertSuccess, alertInfo, confirmDialog } from '@/common/ui/alert.js'; // ★ confirmDialog 추가
import MenuTree from '@/features/menu/components/MenuTree.jsx';
import MenuEditor from '@/features/menu/components/MenuEditor.jsx';
import '@/features/system/styles/admin.css';
import '@/features/menu/styles/admin-menu.css';
