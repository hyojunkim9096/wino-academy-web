// src/common/contexts/AuthContext.jsx
import React, { createContext, useContext, useEffect, useRef, useState, useCallback } from 'react';
// ✅ [수정] login(API), logout(API), setAuthToken(헤더설정), clearAuthState(헤더제거) import
import { fetchMe, ping, initSessionAfterLogin, login as apiLogin, logout as apiLogout, setAuthToken, clearAuthState } from '@/common/api/authApi.js';
import { getMyMenus } from '@/features/menu/api/menuApi.js';
